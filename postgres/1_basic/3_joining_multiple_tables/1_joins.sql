...
-- LEFT JOIN and LEFT OUTER JOIN is the same
SELECT a, fruit_a, b, fruit_b
FROM basket_a LEFT JOIN basket_b ON fruit_a = fruit_b

SELECT a, fruit_a, b, fruit_b
FROM basket_a LEFT OUTER JOIN basket_b ON fruit_a = fruit_b

SELECT a, fruit_a, b, fruit_b
FROM basket_a LEFT JOIN basket_b ON fruit_a = fruit_b
WHERE b IS NULL

-- RIGHT JOIN and RIGHT OUTER JOIN is the same
SELECT a, fruit_a, b, fruit_b
FROM basket_a RIGHT JOIN basket_b ON fruit_a = fruit_b

SELECT a, fruit_a, b, fruit_b
FROM basket_a RIGHT OUTER JOIN basket_b ON fruit_a = fruit_b
